...
BLNDX holds cap-weighted stocks in developed markets, so the allocation to stocks is actually higher than 50%. Through ZROZ, this portfolio chooses to hold a long position in bonds beyond trend-following. Again, this allocation heavily overweights value stocks and is very different than VT. To reach an 18% allocation of BLNDX, which has a minimum investment of $25K, one would need a total portfolio of nearly $139K. The other share class of the same fund, REMIX, has a minimum investment of only $2.5K but a higher expense ratio.
