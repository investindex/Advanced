...
An important price you should be able to calculate before buying an option is the breakeven price. This is the price the underlying needs to reach by expiration for you to break even. We paid $7.41 per share for the option with a strike price of $45 when XY's price was $50. In order to break even, the act of exercising needs to generate the same value as the premium we paid, which was $741. So the price would need to rise to $45 + $7.41 = $52.41, which is a 4.82% increase from $50. Of course, if the option expires at the breakeven price or slightly above, we would've profited more by investing in shares instead, so this doesn't consider the opportunity cost.
