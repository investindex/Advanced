...
I think those who have the resources to invest in reinsurance, long-short risk premia, and merger arbitrage should consider doing so, since they provide meaningful diversification. But without access to those alternatives, most investors can create a robust portfolio with managed futures, bonds, and factor-tilted stock funds. I would be happy to lock in a 100-year portfolio with something like the final portfolio suggested [above](https://github.com/investindex/Advanced#new-allocations).
