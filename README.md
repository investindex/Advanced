...
Many ETFs have option markets (mutual funds do not). Ideally, I could invest in my [favorite portfolio of ETFs](https://github.com/investindex/Fund/blob/main/README.md#example-portfolio) and buy call options on the same ETFs. But options are not like ETFs, where bid-ask spreads are negligible for long-term investors. Bid-ask spreads on an ETF that isn't especially popular might be 0.1% or 0.2%, but this isn't important because it's still a small spread and you can hold for a very long time. Liquidity becomes a very important consideration for options because you can't hold for an indefinite duration, and spreads on ETFs with very little options activity can be abysmal. It is not hard to find an ETF that has some options with 50% bid-ask spreads. Spreads on a given security's options tend to be larger for options with more distant expiration dates and strike prices that are further from the market price (deep ITM or OTM), because those options are traded less frequently.
